...
-- 菜单路由名和路径也需要跟随品牌改造统一，否则旧版初始化脚本仍会把旧品牌写回数据库。
INSERT INTO  sys_menu (menu_id, menu_name, menu_type, router_name, parent_id, path, is_button, permission, meta_info, status, remark, creator_id, create_time, updater_id, update_time, deleted) VALUES (4, 'HealthTrail官网', 3, 'HealthTrailguanwangIframeRouter', 0, '/HealthTrailguanwangIframeLink', 0, '', '{"title":"HealthTrail官网","icon":"ep:link","showParent":true,"frameSrc":"https://element-plus.org/zh-CN/","rank":8}', 1, 'HealthTrail官网地址', 0, '2022-05-21 08:30:54', 1, '2023-08-14 23:09:40', 0);
...
INSERT INTO  sys_menu (menu_id, menu_name, menu_type, router_name, parent_id, path, is_button, permission, meta_info, status, remark, creator_id, create_time, updater_id, update_time, deleted) VALUES (63, 'HealthTrail 项目主页', 4, 'https://healthtrail.local', 0, '/external', 0, '', '{"title":"HealthTrail 项目主页","icon":"fa-solid:external-link-alt","showParent":true,"rank":9}', 1, 'HealthTrail 项目主页', 0, '2022-05-21 08:30:54', 1, '2023-08-14 23:12:13', 0);
