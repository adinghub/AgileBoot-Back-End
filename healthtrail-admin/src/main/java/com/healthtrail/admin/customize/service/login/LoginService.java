package com.healthtrail.admin.customize.service.login;
...
import com.healthtrail.common.constant.Constants.Captcha;
...
import com.healthtrail.common.utils.i18n.MessageUtils;
import com.healthtrail.domain.common.cache.GuavaCacheService;
import com.healthtrail.domain.common.cache.MapCache;
import com.healthtrail.domain.common.cache.RedisCacheService;
import com.healthtrail.admin.customize.async.AsyncTaskFactory;
...
import com.healthtrail.common.enums.common.ConfigKeyEnum;
...
public class LoginService {
    ...
    public CaptchaDTO generateCaptchaImg() {
        ...
        if (isCaptchaOn) {
            ...
            // 生成验证码
            String captchaType = HealthTrailConfig.getCaptchaType();
    ...
    public String decryptPassword(String originalPassword) {
        byte[] decryptBytes = SecureUtil.rsa(HealthTrailConfig.getRsaPrivateKey(), null)
