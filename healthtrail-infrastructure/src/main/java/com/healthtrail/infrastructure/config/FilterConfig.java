package com.healthtrail.infrastructure.config;

import com.healthtrail.infrastructure.exception.GlobalExceptionFilter;
import com.healthtrail.infrastructure.filter.TestFilter;
import com.healthtrail.infrastructure.filter.TraceIdFilter;
...
public class FilterConfig {
    ...
    @Value("${healthtrail.traceRequestIdKey}")
