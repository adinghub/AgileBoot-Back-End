package com.healthtrail.infrastructure.i18n;

import cn.hutool.core.convert.Convert;
import cn.hutool.core.util.ArrayUtil;
import com.healthtrail.common.exception.error.ErrorCode;
import com.healthtrail.common.exception.error.ErrorCodeInterface;
...
public class MessageI18nCheckerRunner implements ApplicationRunner {
    ...
    // 这里必须显式使用 ${...} 占位符读取配置项；如果只写成纯文本字符串，
    // Spring 会把字面量直接注入进来，最终导致 i18n 开关永远无法按配置真实生效。
    @Value("${healthtrail.checkI18nKey}")
