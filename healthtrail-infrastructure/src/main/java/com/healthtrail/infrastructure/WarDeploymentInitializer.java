package com.healthtrail.infrastructure;
 ...
 * 将其指向应用启动类。
 * 当前仓库完成 HealthTrail 命名改造后，如果未来需要启用 WAR 部署，这里应指向
 * `HealthTrailAdminApplication.class` 或 `HealthTrailApiApplication.class` 这类新的入口类。
 * @author valarchie
 */
public class WarDeploymentInitializer extends SpringBootServletInitializer {
//    protected SpringApplicationBuilder configure(SpringApplicationBuilder application) {
//        return application.sources(HealthTrailAdminApplication.class);
//    }
}
