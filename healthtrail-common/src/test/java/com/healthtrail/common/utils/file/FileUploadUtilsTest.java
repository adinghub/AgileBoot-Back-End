...
class FileUploadUtilsTest {
    ...
    void getFileAbsolutePath() {
        HealthTrailConfig healthTrailConfig = new HealthTrailConfig();
        healthTrailConfig.setFileBaseDir("D:\\healthtrail");

        String fileAbsolutePath = FileUploadUtils.getFileAbsolutePath(UploadSubDir.AVATAR_PATH, "test.jpg");

        Assertions.assertEquals("D:\\healthtrail\\profile\\avatar\\test.jpg", fileAbsolutePath);
    }
}
