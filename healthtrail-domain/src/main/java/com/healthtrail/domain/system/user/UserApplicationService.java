package com.healthtrail.domain.system.user;
...
import com.healthtrail.domain.system.post.dto.PostDTO;
import com.healthtrail.domain.system.role.dto.RoleDTO;
import com.healthtrail.domain.system.user.command.AddUserCommand;
import com.healthtrail.domain.system.user.command.ChangeStatusCommand;
import com.healthtrail.domain.system.user.command.ResetPasswordCommand;
import com.healthtrail.domain.system.user.command.UpdateProfileCommand;
import com.healthtrail.domain.system.user.command.UpdateUserAvatarCommand;
...
import com.healthtrail.domain.system.user.db.SearchUserDO;
import com.healthtrail.domain.system.user.dto.UserDTO;
import com.healthtrail.domain.system.user.dto.UserDetailDTO;
import com.healthtrail.domain.system.user.dto.UserProfileDTO;
import com.healthtrail.domain.system.user.model.UserModel;
import com.healthtrail.domain.system.user.model.UserModelFactory;
