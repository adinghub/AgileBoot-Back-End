package com.healthtrail.domain.system.monitor;
...
import com.healthtrail.domain.system.monitor.dto.OnlineUserDTO;
import com.healthtrail.domain.system.monitor.dto.RedisCacheInfoDTO;
import com.healthtrail.domain.system.monitor.dto.RedisCacheInfoDTO.CommandStatusDTO;
import com.healthtrail.domain.system.monitor.dto.ServerInfo;
...
/** 系统监控应用服务，提供服务器、JVM、Redis缓存等运维信息查询 */
@Service
@RequiredArgsConstructor
public class MonitorApplicationService {

    /** Redis缓存操作模板，用于查询缓存信息和服务器状态 */
